...
var commands = {
    ...
    "click": new RegExp('^click|leftclick|left click|lclick$', 'i'),
    "rclick": new RegExp('^rclick|right click|rightclick$', 'i'),
    "close": new RegExp('^close|clear$', 'i'),
    "enter": new RegExp('^enter$', 'i'),
    "number": new RegExp('^([1-9])$', 'i'),
    "fkey": new RegExp('^(f[1-8])$', 'i'),
    "numpad": new RegExp('^num([0-7])$', 'i'),
    "run": new RegExp('^run|walk$', 'i'),
    "swap": new RegExp('^swap$', 'i'),
    "left menu": new RegExp('^left ?menu$', 'i'),
    "right menu": new RegExp('^right ?menu|menu|abilities|ability$', 'i'),
    "stats": new RegExp('^stats|char|character$', 'i'),
    "inv": new RegExp('^inv|inventory|bag|bags$', 'i'),
    "skills": new RegExp('^skills|tree|skill ?tree|talents$', 'i'),
    "map": new RegExp('^map$', 'i'),
    "quests": new RegExp('^quests?$', 'i'),
    "merc": new RegExp('^merc$', 'i'),
}
